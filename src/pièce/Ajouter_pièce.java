...
String path;
    public Ajouter_pièce() throws Exception {
        ...
        ImageIcon icon = new ImageIcon("â€ªC:\\Users\\HP\\OneDrive\\Bureau\\webagency\\image\\Email-marketing.jpg");
    ...
    private void AjouterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AjouterActionPerformed
        Date date = new Date();
        try {
            if   (piece.getText().equals("")||piece.getText().equals("Nom_PiÃ¨ce")){
                JOptionPane.showMessageDialog(null, "Nom_PiÃ¨ce !",
                        "", JOptionPane.INFORMATION_MESSAGE);
            } else if (type1.getText().equals("") || type1.getText().equals("Type PiÃ¨ce")) {
               ...
               pièce pièce = new pièce(piece.getText(), type1.getText(),image_chemin);
                ...
                historique histo = new historique("Ajouter PiÃ¨ce", date);
    ...
    private void supprimerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_supprimerActionPerformed
        ...
        if (indexrow < 0) {
            JOptionPane.showMessageDialog(null, "Vueillez de selectionner une piÃ¨ce !",
                    "", JOptionPane.INFORMATION_MESSAGE);
        }else{
            ...
            try {
                ...
                historique histo = new historique("Supprimer PiÃ¨ce", date);
                currentuser = Bd.getcurrentAdmin(Authentification.usercurrent);
                BD.inserthistorique(histo.getId(), currentuser.split("_")[0], histo);
                piece.setText("Nom_PiÃ¨ce");
                type1.setText("Type PiÃ¨ce");
    ...
    private void piece1FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_pieceFocusGained
        if (piece.getText().equals("Nom_PiÃ¨ce")) {
            piece.setText("");
        }
    ...
    private void type1FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_type1FocusGained
        if (type1.getText().equals("Type PiÃ¨ce")) {
            type1.setText("");
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new Ajouter_piÃ¨ce().setVisible(true);
            }
        });
    }
