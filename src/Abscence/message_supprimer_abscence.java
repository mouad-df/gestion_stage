...
public class message_supprimer_abscence extends javax.swing.JFrame {
BD_admin bd;
BD_stagiaire Bd;
BD_historique BD;
BD_Abscence dB;
...
DefaultTableModel model ;
    public message_supprimer_abscence() throws Exception {
        initComponents();
       ...
       setLocation (size.width/2 -getWidth ()/2, size.height/2 -getHeight ()/2);
        ...
        dB= new BD_Abscence("localhost", 3306, "Gestion_Stages", "root", "");
         indexrow = gestion_abscence.table1.getSelectedRow();
         model = (DefaultTableModel) gestion_abscence.table1.getModel();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Voulez-vous vraiment supprimer cette Abscence");
    ...
    private void fermer1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fermer1ActionPerformed
       DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        Date date = new Date();
        try {   
             dB.supprimerAbscence(model.getValueAt(indexrow, 0).toString() ,model.getValueAt(indexrow, 1).toString(),
             model.getValueAt(indexrow, 2).toString(), model.getValueAt(indexrow, 3).toString(),model.getValueAt(indexrow, 4).toString(),model.getValueAt(indexrow, 5).toString());
            this.hide();
            model.removeRow(indexrow);
            historique histo = new historique("Supprimer Abscence", date);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(message_supprimer_abscence.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
